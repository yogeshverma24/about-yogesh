...
const colors = {
  primary: {
    50: '#f5f3ff',
    100: '#ede9fe',
    500: '#8b5cf6', // The Signature Purple
    600: '#7c3aed',
    900: '#4c1d95',
  },
  gradient: {
    ...
    <div className="w-full transition-colors duration-500" style={{ backgroundColor: isDark ? '#0f172a' : '#ffffff' }}>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 text-center overflow-hidden">
        ...
        <motion.p 
          ...
          className="mt-6 text-xl md:text-2xl font-medium max-w-2xl opacity-80"
          style={{ color: textSecondary }}
        >
          iOS Developer specializing in high-performance apps, clean architecture, and delightful user experiences.
        </motion.p>
        ...
        <div className="absolute bottom-10 flex gap-6 opacity-40">
           <Github className="w-5 h-5" />
           <Linkedin className="w-5 h-5" />
           <div className="flex items-center gap-2 text-sm font-bold"><MapPin className="w-4 h-4" /> Gurugram, India</div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="text-lg font-medium opacity-70 mb-10" style={{ color: textSecondary }}>
              I focus on building apps that are not just functional, but follow Apple&apos;s Human Interface Guidelines for the best user experience.
            </p>
